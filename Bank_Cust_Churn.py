...
sns.boxplot(x="Exited",y="CreditScore",data=df,hue="Exited",ax=ax3[0][0])
sns.boxplot(x="Exited",y="Age",data=df,hue="Exited",ax=ax3[0][1])
sns.boxplot(x="Exited",y="Tenure",data=df,hue="Exited",ax=ax3[1][0])
sns.boxplot(x="Exited",y="Balance",data=df,hue="Exited",ax=ax3[1][1])
